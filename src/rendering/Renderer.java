...
public class Renderer {
    ...
    public void stencilRender(WorldObject gameObject) {
        enableOutline();
    ...
    public void render(ArrayList<WorldObject> gameObjects) {
        for (WorldObject gameObject : gameObjects) {
            render(gameObject);
        }
    }

    public void render(WorldObject gameObject) {
        shaderProgram.use();
